// @ts-nocheck
/* eslint-disable prefer-const -- legacy md5 */
...
export function hashColor(str: string | number | null | undefined): string {
  if (str === null || str === undefined || str === '') return '#dfdfdf';
...
export function findCamera(devices: MediaDeviceInfo[]): MediaDeviceInfo | undefined {
